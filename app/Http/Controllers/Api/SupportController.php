...
class SupportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return ApiAdapter::toJason($supports);
    }
     ...
     */
    public function show(string $support)
    {
     ...
     */
    public function update(StoreUpdateSupportRequest $request, string $support)
    {
     ...
     */
    public function destroy(string $support)
    {
        if (!$this->service->findOne($support)) {
            return response()->json(['error' => 'Not Found'], Response::HTTP_NOT_FOUND);
        }
